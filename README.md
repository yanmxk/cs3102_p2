...
├── exemplar_drop_logs/                           # Drop utiliy logs example
├── exemplar_logs/                                # Test logs example
├── plots/                                        # Fresh plots figures
├── pics/                                         # Exemplar plots used in report
├── LRTP_Protocol_Analysis.ipynb                  # Analysis scripts
├── run_drop_tests.sh                             # Script for automatic drop test
├── run_tests.sh                                  # Script for automatic tests runner
├── startercode/
