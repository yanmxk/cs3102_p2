/*
  CS3102 Coursework P2 : LRTP Large Transfer Test Server
  
  Companion to test-large-transfer-client. Receives data and sends acknowledgments.
  Monitors RTO adaptation with sustained data transfer.
  
  Usage: ./test-large-transfer-server [port]
*/
...
main(int argc, char *argv[])
{
  ...
  printf("Large Transfer Test Server\n");
